...
while ($utente = mysqli_fetch_array($result))
  $pstreaming.="<input type=\"radio\" name=\"selection\" value=\"{$utente['partita']}\" />
           {$utente['partita']} {$utente['giorno']} {$utente['piattaforma']} (&euro; {$utente['costoPartita']})<br />\n";
...
<h2>Scegli le tue partite in streaming</h2>
<p>Benvenuto <?php echo $_SESSION['username']?>, di seguito tutti le partite disponibili:</p>
